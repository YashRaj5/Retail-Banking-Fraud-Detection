...
# DBTITLE 1,Setting data directory
folder = "/tmp/fsi/fraud-detection"

# COMMAND ----------

# return true if the folder is empty or does not exist
...
# DBTITLE 1,downloading file from url
# to download files
...
# DBTITLE 1,downloading file from git source
